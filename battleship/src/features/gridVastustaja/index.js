...
export class Grid2 extends Component {
  render() {
    return (
      <div
        style={{
      ...
      >
        {[...Array(11)].map((_, rowI) => (
          <GridRow tiles={this.props.oppboard[rowI]} y={rowI} key={rowI} />
        ))}
      </div>
    );
  }
...
function oppClickHandler(e) {
  let props = store.getState().grid2;
  if (
